...
import { ArrowLeft, CheckCircle, Volume2, Sun, Moon } from "lucide-react";
      ...
      <div className="px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
          >
            <Card className={`backdrop-blur-xl transition-colors duration-300 p-12 mb-8 relative overflow-hidden shadow-lg ${isDark ? "bg-black/40 border border-white/10" : "bg-white/90 border border-gray-300"}`}>
              {/* Gradient background */}
